...
#     command = <<EOF
#     aws ecr get-login-password --region ${var.ecr_config.public_ecr_region} | docker login --username AWS --password-stdin ${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.aws_config.aws_region}.amazonaws.com
...
#   type  = "SecureString"
#   value = var.aws_config.consul_ca_certificate_b64 #var.lambda_config.consul_ca_cert
#   tier  = "Advanced"
# }
...
#   name                      = var.ecr_config.ecr_repository_name
#   consul_http_addr          = var.aws_config.hcp_consul_endpoint #var.lambda_config.kubernetes_control_plane
...
#   subnet_ids                = var.aws_config.private_subnets
...
#   filename         = var.lambda_payments_path
#   source_code_hash = filebase64sha256(var.lambda_payments_path)
